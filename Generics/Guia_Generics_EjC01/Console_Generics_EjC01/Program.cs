using System;
using Guia_Generics_EjC01;

namespace Console_Generics_EjC01
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Competencia<AutoF1> competenciaAutos = new Competencia<AutoF1>(10, 3, Competencia<AutoF1>.TipoCompetencia.F1);
            Competencia<MotoCross> competenciaMotos = new Competencia<MotoCross>(8, 2, Competencia<MotoCross>.TipoCompetencia.MotoCross);

            //Instancio autos
            AutoF1 a1 = new AutoF1(1, "Mercedes", 300);
            AutoF1 a2 = new AutoF1(2, "Bmw", 250);
            AutoF1 a3 = new AutoF1(3, "Ferrari", 450);
            AutoF1 a4 = new AutoF1(4, "Renault", 280);

            //Instancio Motos
            MotoCross m1 = new MotoCross(15, "Harley", 200);
            MotoCross m2 = new MotoCross(22, "Zanella", 125);
            MotoCross m3 = new MotoCross(33, "Gilera", 125);
